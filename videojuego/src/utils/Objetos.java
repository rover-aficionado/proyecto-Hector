...
public class Objetos {
    ...
    public ArrayList<Flecha> listaFlechas(){
        ArrayList<Flecha> flechas = new ArrayList<>();
    ...
    public ArrayList<Grimorio> listaGrimorios(){
        ArrayList<Grimorio> grimorios = new ArrayList<Grimorio>();
    ...
    public ArrayList<Hechizo> listaHechizos(){
